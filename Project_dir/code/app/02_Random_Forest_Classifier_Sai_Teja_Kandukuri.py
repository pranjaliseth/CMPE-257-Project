...
## Implementing random forest classifier for amazon reviews rating classification/prediction.
"""
...
probas = rfc_os.predict_proba(X_test_os)
sns.set(rc={'figure.figsize':(10,10)})
sns.set(font_scale=1)
skplt.metrics.plot_precision_recall_curve(y_test_os, probas)
plt.show()
...
print(log_loss(y_test_os, probas))
...
"""The rating predictions are pretty good/accurate. """
...
"""The rating predictions are not up to the mark."""
